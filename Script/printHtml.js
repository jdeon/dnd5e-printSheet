...
export default class PrintSheetHtml { 
    ...
    static generateTab(titre, valeur,style){
        let outText = '<div style="' + style + '">';
        outText += '<table>';
        outText += this.addToVerticalTable(titre, valeur);
        outText += '</table>';
        outText += '</div>';
    ...
    static addToVerticalTable (titre, valeur){
        let outText = '<tr>';
        outText += '<th scope="col">' + titre + '</th>';
        outText += '</tr>';
        
        for(let i=0 ; i < valeur.length; i ++){
            outText += '<tr>';
            outText += '<td>'
            outText += this.generationSpan(valeur[i]);
            outText += '</td>'
            outText += '</tr>';
        }  
        return outText;
    ...
    static convertdataToHtmlText(data, dataSheet, itemByType) {
        ...
        outText += '<div style="float:left;width:100%">'
        
        outText += '<div style="float:left;width:30%">';
        outText += '<h1> Nom personnage : ' + data.name + '</h1>';
        outText += '</div>';
        
        outText += this.generateHeaderPart(data, itemByType);
        outText += '</div>';
        
        outText += '<div style="float:left;width:30%">';
        outText += this.generateCaracteristiquePart(data);
        outText += '</div>';
        
        outText += '<div style="float:left;width:30%">';
        outText += '<div style="float:right;width:100%">';
        outText += this.generateTab('PV', [data.data.attributes.hp.value], 'float:left;width:30%');
        outText += this.generateTab('CA', [data.data.attributes.ac.value], 'float:left;width:30%');   
        outText += this.generateTab('Vitesse', [data.data.attributes.movement.walk + 'm'], 'float:left;width:30%');
        outText += this.generateTab('Vision', [Object.entries(data.data.attributes.senses)], 'float:left;width:100%');
        outText += '</div>';
        
        //Compétence
        outText += '<div style="float:right;width:100%">';
        outText += '<h2>Compétence</h2>';
        outText += '<table>';
        outText += '<tr>';
        outText += '<th>Nom</th><th>Modificateur</th><th>Passive</th>';
        outText += '</tr>';
        for (const [key, skill] of Object.entries(dataSheet.data.skills)){
            outText += '<tr>';
            outText += '<td>' + DND5E.skills[key] + '</td>';
            outText += '<td>' + skill.total + '</td>';
            outText += '<td>' + skill.passive + '</td>';
            outText += '</tr>';
        } 
        outText += '</table>';
        outText += '</div>';
        ...
        outText += '<div style="float:left;width:30%">';
        outText += this.generatePersonalityPart(data);
        outText += '</div>';
        ...
        outText += '<div style="float:left;width:100%">';
        outText += '<h2>Capacité</h2>';
        outText += '<table>';
        outText += '<tr>';
        outText += '<th>Nom</th><th>Description</th>';
        outText += '</tr>';
        for(var i = 0; i < itemByType.capacites.length; i ++){
            let capacite = itemByType.capacites[i];
            outText += '<tr>';
            outText += '<td>' + capacite.name + '</td><td>' + capacite.data.description.value + '</td>';
            outText += '</tr>';
        }
        outText += '</table>';
        outText += '</div>';
        ...
        outText += '<table>';
        outText += '<tr>';
        outText += '<th>Nom</th><th>Niveau</th><th>Activation</th><th>Composant</th><th>Description</th>';
        outText += '</tr>';
         for(var i = 0; i < itemByType.sorts.length; i ++){ 
            let sort = itemByType.sorts[i];
             
            outText += '<tr>';
            outText += '<td>' + sort.name + '</td>';
            outText += '<td>' + sort.data.level + '</td>';
            outText += '<td>' + sort.data.activation.cost + ' ' + sort.data.activation.type + '</td>';
            outText += '<td>' + (sort.data.components.vocal ? 'V,' : '') + (sort.data.components.somatic ? 'S,' : '') + (sort.data.components.material ? 'M (' + sort.data.materials.value + '),' : '') +           (sort.data.components.ritual ? 'R,' : '') + (sort.data.components.concentration ? 'C,' : '') + '</td>';
            outText += '<td>' + sort.data.description.value + '</td>';
            outText += '</tr>';
        }
        outText += '</table>';
        outText += '</div>';
        ...
        outText += '<div style="float:left;width:100%">';
        outText += '<h2>Iventaire</h2>';
       
        outText += '<table>';
        outText += '<tr>';
        outText += '<th>pp</th><th>po</th><th>pe</th><th>pa</th><th>pc</th>';
        outText += '</tr>';
        outText += '<tr>';
        outText += '<td>'+data.data.currency.pp + '</td><td>' + data.data.currency.gp + '</td><td>' + data.data.currency.ep + '</td><td>' + data.data.currency.sp + '</td><td>' + data.data.currency.cp + '</td>';
        outText += '</tr>';
        outText += '</table>';
        outText += '</br>';
        ...
        outText += '<table>';
        outText += '<tr>';
        outText += '<th>Nom</th><th>Quantite</th><th>Description</th>';
        outText += '</tr>';
        for(var i = 0; i < itemByType.objets.length; i ++){
            let objet = itemByType.objets[i];
            
            outText += '<tr>';
            outText += '<td>' + objet.name + '</td>';
            outText += '<td>' + objet.data.quantity + '</td>';
            outText += '<td>' + objet.data.description.value + '</td>';
            outText += '</tr>';
        }
        outText += '</table>';
        outText += '</div>';
        ...
        outText += '</div>'; //div id=globalContainner
        outText += '</body>';
        outText += '</html>';
    ...
    static generateHeaderPart(data, itemByType){
        let outText = '<div style="float:left;width:70%">';
        outText += '<table>';
        outText += '<tr>';
        
        outText += '<td>';
        outText += this.generationSpan('Classe :');     
        let textClass = ''
        for(var i = 0; i < itemByType.classes.length; i ++){
            let classe = itemByType.classes[i];
            textClass += classe.name + ' (' + classe.data.levels + ') - ' +  classe.data.subclass + ';    ';
        }
        outText += this.generationSpan(textClass);
        outText += '</td>';
        
        outText += '<td>';
        outText+= this.generationSpan('Historique :');
        outText+= this.generationSpan(data.data.details.background);
        outText += '</td>';
        
        outText += '<td>';
        outText+= this.generationSpan('Nom joueur :');
        outText+= ''//TODO
        outText += '</td>';
        ...
        outText += '<td>';
        outText+= this.generationSpan('Race :');
        outText+= this.generationSpan(data.data.details.race);
        outText += '</td>';
        
        outText += '<td>';
        outText+= this.generationSpan('Alignement :');
        outText+= this.generationSpan(data.data.details.alignment);
        outText += '</td>';
        
        outText += '<td>';
        outText+= this.generationSpan('Xp :');
        outText+= this.generationSpan(data.data.details.xp.value);
        outText += '</td>';
    ...
    static generateCaracteristiquePart(data){
        let outText = '<div style="float:left;width:70px">';
        
        outText += '<table>';
        outText += this.addToVerticalTable('Force', [data.data.abilities.str.value, data.data.abilities.str.proficient === 1 ? 'X' : '-']);
        outText += this.addToVerticalTable('Dexterite', [data.data.abilities.dex.value, data.data.abilities.dex.proficient === 1 ? 'X' : '-']);
        outText += this.addToVerticalTable('Constitution', [data.data.abilities.con.value, data.data.abilities.con.proficient === 1 ? 'X' : '-']);
        outText += this.addToVerticalTable('Inteligence', [data.data.abilities.int.value, data.data.abilities.int.proficient === 1 ? 'X' : '-']);
        outText += this.addToVerticalTable('Sagesse', [data.data.abilities.wis.value, data.data.abilities.wis.proficient === 1 ? 'X' : '-']);
        outText += this.addToVerticalTable('Charisme', [data.data.abilities.cha.value, data.data.abilities.cha.proficient === 1 ? 'X' : '-']);  
        outText += '</table>';
        outText += '</div>';
    ...
    static generatePersonalityPart(data){
        let outText = '<div>';       
        outText += '<table>';
        outText += this.addToVerticalTable('Trait', [data.data.details.trait]);
        outText += this.addToVerticalTable('Idéal', [data.data.details.ideal]);
        outText += this.addToVerticalTable('Lien', [data.data.details.bond]);
        outText += this.addToVerticalTable('Défaut', [data.data.details.flaw]);
        outText += '</table>';
        outText += '</div>';
        
        outText += '<div>';
        outText += this.generateTab('Biographie',[data.data.details.biography.value], '');
        outText += '</div>';
        
        outText += '<div>';
        outText += this.generateTab('Apparence',[data.data.details.appearance], '');
        outText += '</div>';
